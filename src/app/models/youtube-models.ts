...
export enum ChannelID {
    UCUfabDg40ZH3QXc6SwJLEQ = 'UCUfabDg4-0ZH3QXc6SwJLEQ',
}

export enum ChannelTitle {
    VictorManuelPedrazaMoreno = 'victor manuel pedraza moreno',
}

export enum PlaylistID {
    PLPBu4QV8Z71H2YyCE5P7JxKOXpv3ZQJ = 'PLP-Bu4qV8Z71H2yyCE5p7jx-kOXpv3ZQJ',
}
...
const typeMap: any = {
    ...
    'ChannelID': [
        'UCUfabDg4-0ZH3QXc6SwJLEQ',
    ],
    'ChannelTitle': [
        'victor manuel pedraza moreno',
    ],
    'PlaylistID': [
        'PLP-Bu4qV8Z71H2yyCE5p7jx-kOXpv3ZQJ',
    ],
    'ResourceIDKind': [
        'youtube#video',
    ],
